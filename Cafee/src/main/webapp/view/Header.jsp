        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        	<%
							   ...
							   %>	
                        		<li><a class="dropdown-item" href="productnv.jsp?category=<%=c.getCategoryId()%>"><%=c.getCategoryName() %></a></li>
                        	       <%
									}
									%>                                            
                        </ul>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="productnv.jsp?category=all">Sản phẩm</a>
                    </li>
